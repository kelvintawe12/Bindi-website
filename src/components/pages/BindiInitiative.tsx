...
export function BindiInitiative() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">BINDI: Expanding Access to Educational Materials in Rwanda</h1>
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">1. Initiative Overview</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">3. Project Goals</h2>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">4. Target Communities (Mapping the Need)</h2>
        <p>
        ...
        <ul className="list-disc list-inside mb-2">
          ...
          <li><strong>Kibeho Sector, Nyaruguru District (Southern Province)</strong>: According to the Rwanda Poverty Mapping Report, Kibeho is a semi-rural area where the poverty rate exceeds 40%. Many families cannot afford to buy books, and teachers in the region often express the need for more storybooks and creative learning materials to improve literacy rates among young children.</li>
        </ul>
      </section>

      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">5. Key Activities</h2>
        <ul className="list-disc list-inside">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">6. Potential Partners in Rwanda</h2>
        <p>
        ...
        <ul className="list-disc list-inside">
          <li>Save the Children Rwanda (Website) – Focuses on education and child protection; implements reading and literacy programs across Rwanda.</li>
          <li>Imbuto Foundation (Website) – Runs the 'Promotion of Girls’ Education' program and supports child development and early education.</li>
          <li>Book Aid International (Website) – Partners with local libraries and institutions to improve access to books.</li>
          <li>Ready for Reading_Rwinkwavu Library and Learning Center (Website) – Provides literacy resources, library services, and learning programs for rural communities.</li>
        </ul>
      </section>

      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">7. Impact Vision</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">8. Next Steps</h2>
        <ul className="list-disc list-inside">
          ...
          <li>Collect baseline data to assess current access to books in target communities and create content showcasing the feedbacks and impact of the initiative.</li>
        </ul>
      </section>
