...
export function CtaBanner() {
  return (
    <section className="py-16 bg-coral-500 text-white w-full">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-6">
          Join the Bindi Literacy Initiative
        </h2>
        <p className="text-xl max-w-2xl mx-auto mb-8">
          Help us expand access to educational materials in Rwanda. Together, we can combat literacy challenges and empower young learners with the tools they need to thrive.
        </p>
