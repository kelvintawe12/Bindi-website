      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="bg-blue-900 text-white p-8 md:p-12 rounded-lg shadow-lg">
            <svg className="h-12 w-12 text-yellow-500 mb-6 opacity-50" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
          ...
          <div className="flex justify-between mt-8">
            <button onClick={prevTestimonial} className="bg-gray-200 hover:bg-gray-300 text-blue-900 p-3 rounded-full transition-colors" aria-label="Previous testimonial">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
            </button>
            <button onClick={nextTestimonial} className="bg-gray-200 hover:bg-gray-300 text-blue-900 p-3 rounded-full transition-colors" aria-label="Next testimonial">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
